...
})(["display:grid;grid-gap:40px;margin:0 auto;grid-template-columns:1fr 1fr;"]);
...
function (_Component) {
  ...
  function Items() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_renderItems", function () {
      var data = _this.props.items.data;
      if (!lodash_size__WEBPACK_IMPORTED_MODULE_5___default()(data)) return;
...
//# sourceMappingURL=index.js.0f033b5911fb4acafc12.hot-update.js.map
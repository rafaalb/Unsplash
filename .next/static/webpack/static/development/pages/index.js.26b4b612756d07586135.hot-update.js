...
var drawerWidth = 280;
var Footer = styled_components__WEBPACK_IMPORTED_MODULE_22__["default"].div.withConfig({
  displayName: "Drawer__Footer",
  componentId: "sc-16uzmax-0"
})(["width:100%;margin-top:20px;margin-bottom:20px;position:", ";bottom:0;display:flex;align-items:center;justify-content:space-between;padding-left:20px;padding-right:20px;background-color:#18171c;a{font-size:10px;color:white;}"], function (props) {
  return props.isOpen ? 'absolute' : 'fixed';
});
...
//# sourceMappingURL=index.js.26b4b612756d07586135.hot-update.js.map
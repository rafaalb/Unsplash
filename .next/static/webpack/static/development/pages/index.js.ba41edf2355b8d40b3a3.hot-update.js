...
var fetchUsers = function fetchUsers(payload) {
  return function (dispatch) {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["endpoint"], "/users/").concat(payload, "?client_id=").concat(_config__WEBPACK_IMPORTED_MODULE_1__["ACCESS_KEY"])).then(function (res) {
      console.log(res);
...
//# sourceMappingURL=index.js.ba41edf2355b8d40b3a3.hot-update.js.map